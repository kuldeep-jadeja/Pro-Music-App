        ...
        <>
          {isNewUser ? (
            ...
            <div className={styles.onboardingWrap}>
              ...
              <h1 className={styles.onboardingTitle}>Add your first playlist</h1>
              <p className={styles.onboardingSubtitle}>
                Paste a Spotify playlist link and we&apos;ll match every track to YouTube for free playback.
              </p>
              <div className={styles.onboardingSteps}>
                ...
                <span className={styles.onboardingStepArrow}>→</span>
                <span className={styles.onboardingStep}>
              ...
              <div className={styles.onboardingFormWrap}>
                <div className={styles.onboardingFormHeader}>
                  <svg
                    style={{ width: 32, height: 32, flexShrink: 0, color: '#1ed760' }}
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    aria-hidden="true"
                  >
                  ...
                  <div>
                    <p className={styles.onboardingFormTitle}>Import from Spotify</p>
                    <p className={styles.onboardingFormDesc}>Paste a public playlist URL below</p>
                  </div>
                </div>
            ...
            /* ── Regular authenticated view ── */
            <>
              {/* Hero greeting */}
              <div className={styles.hero}>
                <div className={styles.heroBadge}>✦ Free forever</div>
        ...
        <div className={styles.loginCta}>
          ...
          <div className={styles.ctaStats}>
            <div className={styles.ctaStat}>
              <span className={styles.ctaStatValue}>1M+</span>
              <span className={styles.ctaStatLabel}>Tracks streamed</span>
            </div>
            <div className={styles.ctaStat}>
              <span className={styles.ctaStatValue}>10K+</span>
              <span className={styles.ctaStatLabel}>Playlists imported</span>
            </div>
            <div className={styles.ctaStat}>
              <span className={styles.ctaStatValue}>Free</span>
              <span className={styles.ctaStatLabel}>Always</span>
            </div>
          </div>
        </div>
      )}
