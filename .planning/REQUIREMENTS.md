...
- [x] **SYNC-02**: Existing background workers (`metadataWorker`, `artistCrawler`, `chartsWorker`, `ytMatchWorker`, and other active workers) continue processing without regression while admin expansion jobs are queued
